...
public class Hud {
    ...
    public Hud(SpriteBatch sb, BitmapFont font) {
        worldTimer = 300;
        timeCount = 0;
        score = 0;

        viewport = new FitViewport(Grotto.V_WIDTH, Grotto.V_HEIGHT, new OrthographicCamera());
        ...
        grottoLabel = new Label("GROTTO", new Label.LabelStyle(font, Color.WHITE));

        table.add(grottoLabel).expandX().padTop(10);
